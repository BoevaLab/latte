...
Taken from https://github.com/mutualinfo/mutual_info.
"""
import numpy as np
...
def handle_transform(X, transform):
    allowed_transforms = {"rank": rank_transform, "standardize": standardize_transform, None: lambda x: x}
...
def rank_transform(x, pct=True):
    ...
    See https://stackoverflow.com/questions/5284646/rank-items-in-an-array-using-python-numpy-
        without-sorting-array-twice/59864018#59864018 for more notes
    """
